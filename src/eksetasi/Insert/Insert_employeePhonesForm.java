 ...
 * @author user
 */
public class Insert_employeePhonesForm extends javax.swing.JFrame {

    /**
     * Creates new form Insert_employeePhonesForm
     */
    public Insert_employeePhonesForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        phoneNumber_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
    ...
    private void Insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Insert_buttonActionPerformed
        ...
        try{
            ...
            String phoneText = phoneNumber_field.getText().trim();

            if(idText.isEmpty() && phoneText.isEmpty()){
               JOptionPane.showMessageDialog(null, "Εισάγετε ID και τηλέφωνο");
               return;
            } 
               ...
               JOptionPane.showMessageDialog(null, "Εισάγετε τηλέφωνο");
               return;
            }
            ...
            String sql = "INSERT INTO employeephones (EmployeeID, PhoneNumber) "
                       + "VALUES (?, ?)";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                pstmt.setInt(1, id);
                pstmt.setString(2, phoneText);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_employeePhonesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_employeePhonesForm().setVisible(true);
            }
        });
    }
