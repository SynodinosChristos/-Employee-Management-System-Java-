 ...
 * @author user
 */
public class Insert_unpaidAbsencesForm extends javax.swing.JFrame {

    /**
     * Creates new form Insert_unpaidAbsencesForm
     */
    public Insert_unpaidAbsencesForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        absenceDate_field = new javax.swing.JTextField();
        ...
        absenceDays_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        absenceDays_field.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                absenceDays_fieldActionPerformed(evt);
            }
        });
        ...
        year_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        absenceDate_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(year_field, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(59, 59, 59))
                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(285, 285, 285)
                        .addComponent(Insert_button, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(259, 259, 259)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(absenceDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel5)
                                .addComponent(absenceDays_field, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel5)
                        .addGap(18, 18, 18)
                        .addComponent(absenceDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(45, 45, 45)))
    ...
    private void absenceDays_fieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_absenceDays_fieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_absenceDays_fieldActionPerformed
    ...
    private void Insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Insert_buttonActionPerformed
        ...
        try{
            ...
            String absenceDays = absenceDays_field.getText().trim();
            String year = year_field.getText().trim();
            String absenceDate = absenceDate_field.getText().trim();
            String idText = ID_field.getText().trim();
            if(idText.isEmpty() && absenceDays.isEmpty() && year.isEmpty() && absenceDate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ID, ημέρες απουσίας, έτος και ημερομηνία απουσίας");
                return;
            }
            ...
            else if(absenceDays.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ημέρες απουσίας");
                return;
            }
            else if(year.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε έτος");
                return;
            }
            else if(absenceDate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ημερομηνία απουσίας");
                return;
            }
            ...
            try{
                ...
                absenceDays_int = Integer.parseInt(absenceDays);
                year_int = Integer.parseInt(year);
            }
            catch(NumberFormatException e){
                JOptionPane.showMessageDialog(null, "Το ID, ημέρες απουσίας και το έτος πρέπει να είναι αριθμοί");
                return;
            }

            String sql = "INSERT INTO unpaidabsences (EmployeeID, AbsenceDays, Year, AbsenceDate) "
            + "VALUES (?, ?, ?, ?)";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                pstmt.setInt(1, id);
                pstmt.setInt(2, absenceDays_int);
                pstmt.setInt(3, year_int);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_unpaidAbsencesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_unpaidAbsencesForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField absenceDate_field;
