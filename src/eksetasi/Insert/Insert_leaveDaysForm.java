 ...
 * @author user
 */
public class Insert_leaveDaysForm extends javax.swing.JFrame {

    /**
     * Creates new form Insert_leaveDaysForm
     */
    public Insert_leaveDaysForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        leaveDate_field = new javax.swing.JTextField();
        ...
        leaveDays_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        leaveDays_field.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                leaveDays_fieldActionPerformed(evt);
            }
        });
        ...
        leaveDate_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(leaveDays_field, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(65, 65, 65)
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(259, 259, 259)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(leaveDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(leaveDays_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(leaveDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(45, 45, 45)))
    ...
    private void leaveDays_fieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_leaveDays_fieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_leaveDays_fieldActionPerformed
    ...
    private void Insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Insert_buttonActionPerformed
        ...
        try{
            ...
            String leaveDays = leaveDays_field.getText().trim();
            String year = year_field.getText().trim();
            String leaveDate = leaveDate_field.getText().trim();
            String idText = ID_field.getText().trim();
            if(idText.isEmpty() && leaveDays.isEmpty() && year.isEmpty() && leaveDate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ID, ημέρες άδειας, έτος και ημερομηνία άδειας");
                return;
            }
                ...
                JOptionPane.showMessageDialog(null, "Εισάγετε ημέρες άδειας");
                return;
            }
                ...
                JOptionPane.showMessageDialog(null, "Εισάγετε ημερομηνία άδειας");
                return;
            }
            ...
            try{
                ...
                leaveDays_int = Integer.parseInt(leaveDays);
                year_int = Integer.parseInt(year);
            }
            catch(NumberFormatException e){
                JOptionPane.showMessageDialog(null, "Το ID, ημέρες άδειας και το έτος πρέπει να είναι αριθμοί");
                return;
            }

            String sql = "INSERT INTO leavedays (EmployeeID, LeaveDays, Year, LeaveDate) "
            + "VALUES (?, ?, ?, ?)";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                pstmt.setInt(1, id);
                pstmt.setInt(2, leaveDays_int);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_leaveDaysForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_leaveDaysForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField leaveDate_field;
