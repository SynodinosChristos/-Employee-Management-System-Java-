 ...
 * @author user
 */
public class Insert_workHoursForm extends javax.swing.JFrame {

    /**
     * Creates new form Insert_workHoursForm
     */
    public Insert_workHoursForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        workDate_field = new javax.swing.JTextField();
        ...
        jLabel3.setText("Work Date");

        workDate_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        workDate_field.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                workDate_fieldActionPerformed(evt);
            }
        });
        ...
        hoursWorked_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(289, 289, 289)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(workDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(workDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(61, 61, 61)
    ...
    private void workDate_fieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_workDate_fieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_workDate_fieldActionPerformed
    ...
    private void Insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Insert_buttonActionPerformed
        ...
        try{
            ...
            String workDate = workDate_field.getText().trim();
            String hoursWorked = hoursWorked_field.getText().trim();
            String idText = ID_field.getText().trim();
            if(idText.isEmpty() && workDate.isEmpty() && hoursWorked.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ID, ημερομηνία εργασίας και ώρες εργασίας");
                return;
            }
                ...
                JOptionPane.showMessageDialog(null, "Εισάγετε ημερομηνία εργασίας");
                return;
            }
            else if(hoursWorked.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ώρες εργασίας");
                return;
            }
            ...
            String sql = "INSERT INTO workhours (EmployeeID, WorkDate, HoursWorked) "
            + "VALUES (?, ?, ?)";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                pstmt.setInt(1, id);
                pstmt.setString(2, workDate);
                pstmt.setString(3, hoursWorked);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_workHoursForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_workHoursForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField workDate_field;
