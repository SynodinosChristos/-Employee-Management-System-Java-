 ...
 * @author user
 */
public class Insert_sickDaysForm extends javax.swing.JFrame {

    /**
     * Creates new form Insert_sickDaysForm
     */
    public Insert_sickDaysForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        sickDate_field = new javax.swing.JTextField();
        ...
        sickDays_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        sickDays_field.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sickDays_fieldActionPerformed(evt);
            }
        });
        ...
        jLabel5.setText("Sick Date");

        sickDate_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(sickDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(sickDays_field, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(sickDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(45, 45, 45)))
    ...
    private void sickDays_fieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sickDays_fieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sickDays_fieldActionPerformed
    ...
    private void Insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Insert_buttonActionPerformed
        ...
        try{
            ...
            String sickDays = sickDays_field.getText().trim();
            String year = year_field.getText().trim();
            String sickDate = sickDate_field.getText().trim();
            String idText = ID_field.getText().trim();
            if(idText.isEmpty() && sickDays.isEmpty() && year.isEmpty() && sickDate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ID, ημέρες αρρώστιας, έτος και ημερομηνία αρρώστιας");
                return;
            }
            ...
            else if(sickDays.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ημέρες αρρώστιας");
                return;
            }
            ...
            else if(sickDate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ημερομηνία αρρώστιας");
                return;
            }
            ...
            try{
                ...
                sickDays_int = Integer.parseInt(sickDays);
                year_int = Integer.parseInt(year);
            }
            catch(NumberFormatException e){
                JOptionPane.showMessageDialog(null, "Το ID, ημέρες αρρώστιας και το έτος πρέπει να είναι αριθμοί");
                return;
            }

            String sql = "INSERT INTO sickdays (EmployeeID, SickDays, Year, SickDate) "
            + "VALUES (?, ?, ?, ?)";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                pstmt.setInt(1, id);
                pstmt.setInt(2, sickDays_int);
                pstmt.setInt(3, year_int);
                pstmt.setString(4, sickDate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_sickDaysForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_sickDaysForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField sickDate_field;
