 ...
 * @author user
 */
public class Insert_authorizationForm extends javax.swing.JFrame {

    /**
     * Creates new form Insert_authorizationForm
     */
    public Insert_authorizationForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(password_field, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(66, 66, 66))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void Insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Insert_buttonActionPerformed
        ...
        try{
            ...
            if(idText.isEmpty() && userName.isEmpty() && password.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ID, όνομα χρήστη και κωδικό πρόσβασης");
                return;
            }
                ...
                JOptionPane.showMessageDialog(null, "Εισάγετε όνομα χρήστη");
                return;
            }
            else if(password.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε κωδικό πρόσβασης");
                return;
            }
            ...
            String sql = "INSERT INTO authorizedusers (EmployeeID, UserName, Password) "
            + "VALUES (?, ?, ?)";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                pstmt.setInt(1, id);
                pstmt.setString(2, userName);
                pstmt.setBytes(3, password.getBytes());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_authorizationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_authorizationForm().setVisible(true);
            }
        });
    }
