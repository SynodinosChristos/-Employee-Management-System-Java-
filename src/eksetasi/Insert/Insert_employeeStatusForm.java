 ...
 * @author user
 */
public class Insert_employeeStatusForm extends javax.swing.JFrame {

    /**
     * Creates new form Insert_employeeStatusForm
     */
    public Insert_employeeStatusForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        terminationDate_field = new javax.swing.JTextField();
        ...
        jLabel4.setText("Termination Date");

        ID_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N

        hireDate_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N

        terminationDate_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(120, 120, 120)
                                .addComponent(hireDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGap(22, 22, 22))))
                    .addComponent(Insert_button, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(117, 117, 117)
                        .addComponent(terminationDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(38, 38, 38))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(terminationDate_field, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(61, 61, 61))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void Insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Insert_buttonActionPerformed
        ...
        try{
            ...
            String hireDate = hireDate_field.getText().trim();
            String terminationDate = terminationDate_field.getText().trim();
            String idText = ID_field.getText().trim();
            if(idText.isEmpty() && hireDate.isEmpty() && terminationDate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ID και ημερομηνίες πρόσληψης/απόλυσης");
                return;
            }
                ...
                JOptionPane.showMessageDialog(null, "Εισάγετε ημερομηνία πρόσληψης");
                return;
            }
            else if(terminationDate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Εισάγετε ημερομηνία απόλυσης");
                return;
            }
            ...
            String sql = "INSERT INTO employeestatus (EmployeeID, HireDate, TerminationDate) "
            + "VALUES (?, ?, ?)";
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                pstmt.setInt(1, id);
                pstmt.setString(2, hireDate);
                pstmt.setString(3, terminationDate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_employeeStatusForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_employeeStatusForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField terminationDate_field;
