 ...
 * @author user
 */
public class SalaryReceiptForm extends javax.swing.JFrame {

    /**
     * Creates new form SalaryReceiptForm
     */
    public SalaryReceiptForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        employeeID_field.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(54, 54, 54)
                                .addComponent(employeeID_field, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(72, 72, 72)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(72, 72, 72)
                                .addComponent(firstname_field, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(99, 99, 99)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(58, 58, 58)
                                .addComponent(lastname_field, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(year_field, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30))))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void select_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select_buttonActionPerformed
        ...
        String firstname = firstname_field.getText().trim().toLowerCase();
        String lastname = lastname_field.getText().trim().toLowerCase();
        String IDtext = employeeID_field.getText().trim();
        String yearText = year_field.getText().trim();
        try{
            conn = DriverManager.getConnection(LoginForm.CONN_STRING, LoginForm.USERNAME, LoginForm.PASSWORD);
            int id = -1;
            int year = -1;
            if(!IDtext.isEmpty() && !yearText.isEmpty()){
                try{
                    id = Integer.parseInt(IDtext);
                    year = Integer.parseInt(yearText);
                }
                catch(NumberFormatException ex){
                    JOptionPane.showMessageDialog(null, "Το ID και το έτος πρέπει να είναι αριθμοί.");
                    return;
                }               
            }
            if(id == -1 && firstname.isEmpty() && lastname.isEmpty() && year == -1){
                JOptionPane.showMessageDialog(null, "Παρακαλώ εισάγετε ID και έτος ή ονοματεπώνυμο για αναζήτηση.");
                return;
            }
            
            String sql = """
                         SELECT employees.EmployeeID, FirstName, LastName, Year, Month, Salary FROM employees
                         JOIN salary
                         ON employees.EmployeeID = salary.EmployeeID WHERE ((? <> -1 AND employees.EmployeeID = ?)
                         OR (? = -1 AND LOWER(FirstName) LIKE ? AND LOWER(LastName) LIKE ?)) AND Year = ?
                         ORDER BY Month DESC""";
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if(row != -1){
            ...
            int month = (int) table.getValueAt(row, 4);
            new PrintReceiptForm(employeeID, month).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalaryReceiptForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalaryReceiptForm().setVisible(true);
            }
        });
    }
